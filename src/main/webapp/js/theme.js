...
// add your custom functions 
function instructorCarosule () {
    if ($('#instructor .owl-carousel').length) {
...
// add your custom functions 
function eventCarosule () {
    if ($('#coming-event .owl-carousel').length) {
        $('#coming-event .owl-carousel').owlCarousel({
            loop: true,
            nav: true,
            dots: false,
            margin:10,
