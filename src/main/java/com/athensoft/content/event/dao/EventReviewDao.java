...
public interface EventReviewDao {
	 ...
	 * 
	 * @param queryString
	 *            search criteria of event reviews
	 * @return list of event review objects
	 */
	 ...
	 * 
	 * @param globalId
	 *            the globlaId of news review object
	 ...
	 * 
	 * @param reviewUUID
	 *            the reviewUUID of review object
	...
	/**
	 * remove an event review object from data source
	 * <p>
