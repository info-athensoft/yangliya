...
public class LoginInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		/*
		 * boolean flag = false; for (String s : FILTERS) { if (url.contains(s))
		 * { flag = true; break; } }
		 */
		...
		if (request.getHeader("x-requested-with") != null
			...
			if (session.getAttribute("userAccount") == null) { // if ( s.equals(
																// "null" )) {
	...
	private void sendRedirect(HttpServletRequest request, HttpServletResponse response, String acpLogin, String msg)
			throws IOException {
