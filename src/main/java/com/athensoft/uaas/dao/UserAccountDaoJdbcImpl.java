...
public class UserAccountDaoJdbcImpl implements UserAccountDao {
	...
	private static final Logger logger = LoggerFactory.getLogger(UserAccountDaoJdbcImpl.class);
	...
	public long create(UserAccount userAccount) {
		...
		paramSource.addValue("create_date", new Timestamp(dateCreate.getTime()));
		paramSource.addValue("last_mod_date", new Timestamp(dateLastModified.getTime()));
